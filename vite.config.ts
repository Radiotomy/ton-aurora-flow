...
export default defineConfig(({ mode }) => ({
  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        name: 'AudioTon - Web3 Music Reimagined',
        short_name: 'AudioTon',
        description: 'Stream, mint, and connect in the first TON-integrated Audius client. Discover exclusive NFT music drops, join fan clubs, and own your music journey.',
        theme_color: '#0d1117',
