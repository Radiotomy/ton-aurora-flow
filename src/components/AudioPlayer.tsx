...
export const AudioPlayer: React.FC = React.memo(() => {
  ...
  return (
    <div 
      className={`fixed bottom-0 left-0 right-0 z-50 glass-panel border-0 border-t border-glass-border backdrop-blur-xl bg-background/90 animate-fade-in transition-all duration-300 ${
        shouldShowMinimized ? 'h-12' : ''
      }`}
    >
