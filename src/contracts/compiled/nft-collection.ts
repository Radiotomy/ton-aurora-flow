...
import { getNFTCollectionCode } from '../../utils/contractBytecode';
...
export function getNFTCollectionContractCode(): Cell {
  if (!_cachedBytecode) {
    try {
      ...
      console.warn('Primary NFT Collection BOC parse failed; using generated production bytecode fallback');
      _cachedBytecode = getNFTCollectionCode();
    }
  }
